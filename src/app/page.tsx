            ...
            <div className="text-center text-gray-700 max-w-2xl px-8">
              ...
              <div className="text-left space-y-4 text-gray-600 leading-relaxed">
                <p className="text-lg">
                  ...
                  companion—to get faster and accurate answers on immigration questions.
                </p>
                ...
                <ul className="space-y-2 ml-4">
                  ...
                  <li className="flex items-start">
                    <span className="text-red-600 mr-2">•</span>
                    When an answer includes references, click them to preview the source here on the left. (That's why
                    it looks empty until you pick a link!)
                  </li>
                </ul>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-yellow-800">
                        This is an independent, experimental project and a work in progress. You can expect to see
                        changes often. Always confirm important details with the official IRCC site.
                      </p>
                    </div>
                  </div>
                </div>
